...
public class CallbackMessageSent implements com.microsoft.azure.sdk.iot.device.IotHubEventCallback {
    ...
    public CallbackMessageSent(IoTHubDeviceModule module, ReactContext context) {
        super();
        this.module = module;
    ...
    public void execute(IotHubStatusCode status, Object context) {
        ...
        if (status == IotHubStatusCode.MESSAGE_CANCELLED_ONCLOSE) {
            module.failedMessageListOnClose.add(msg.getMessageId());
        }
        ...
        if ((status == IotHubStatusCode.OK) || (status == IotHubStatusCode.OK_EMPTY)) {
            ...
            EmitHelper.emit(module.getReactContext(), "onMessageSent", params);
        } else {
            sendFailuresCount++;
            WritableMap params = Arguments.createMap();
            params.putString("status", statusJson);
