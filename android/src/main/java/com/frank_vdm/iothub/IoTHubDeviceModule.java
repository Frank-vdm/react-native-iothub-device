...
//                            promise.reject(this.getClass().getSimpleName(), ioException);
    ...
    private DeviceClient CreateIotHubClient(String connectionString, ReadableArray desiredPropertySubscriptions) throws
            URISyntaxException {
        try {
...
//            return null;
    ...
    private void SubscribeToDesiredProperties(DeviceClient newClient, ReadableArray
            desiredPropertySubscriptions) throws
            IOException {
    ...
    private Map<Property, Pair<TwinPropertyCallBack, Object>> CreateSubscriptions(ReadableArray
